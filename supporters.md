...
layout: page
title: Supporters
subtitle: Organisations endorsing the BE-SAFE Next proposal
---

The following organisations have provided a formal letter of support for the **BE-SAFE Next** proposal submitted to the UNITA Call for Advanced Grants on Research.
...
| [![Ville de Pau](/assets/res/endors/pau.png){: width="120"}](https://www.pau.fr)<br>**[Ville de Pau](https://www.pau.fr)** | [📄 View letter](/assets/res/endors/PAU_Municipality_support_letterBE-SAFE.pdf) |
